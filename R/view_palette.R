...
#'
#' @param monochrome_palette Vector of hex color codes, or a `generate_palette()` call
...
#'
#' @return A plot showing all the colors in the palette on the same row
#' @export
#'
#' @examples view_palette(c("#464E69", "#8C90A1", "#D1D2D9"))
#'view_palette(generate_palette("pink", "go_darker", n_colors = 3))
