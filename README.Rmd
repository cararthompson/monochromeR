...
The functions allow for British/NZ spelling and US spelling of colour/color. 
...
I've done my best to make the error messages easy to understand. If you come across a bug or an error message that doesn't make sense, or if there's something you think would make this package better, [please let me know](https://github.com/cararthompson/monochromeR/issues)!
